...
u8  p[TEXT_SIZE] = { 0, 0, 0, 0, 0x12, 0x34, 0x56, 0x78};
u8  nonce[TEXT_SIZE] = { 0, 0, 0, 0, 0x12, 0x34, 0x56, 0x78};
extern void PRESENT_enc(u8* p, u16* rk);
extern void PRESENT_enc_ctr(u8* nonce, u16* rk, u8* p);
int main(void)
{
	//PRESENT_enc(p,rk);
	PRESENT_enc_ctr(nonce,rk,p);
}
